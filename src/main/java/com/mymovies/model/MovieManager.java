...
public class MovieManager {
    ...
    public void addMovie(String title, String director, Float rating, java.sql.Date lastview, String moviePath, String trailerPath, int year, Float imdbScore, CheckBox like) {
    ...
    public void updateMovie(Movie movie, String title, String director, Float rating, java.sql.Date lastview, String moviePath, String trailerPath, int year, Float imdbScore) {
        ...
        movieDao.updateMovie(movie.getId(), title, director, rating, lastview, moviePath, trailerPath, year, imdbScore);
    }
